...
UBUNTU_TRANSLATION_DOMAIN="qml-demo1.netroby"
...
aptest.commands = bash $$PWD/qml-demo1/tests/autopilot/run
aptest.depends  = sub-qml-demo1

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/qml-demo1/tests/unit 
unittest.depends  = sub-qml-demo1
